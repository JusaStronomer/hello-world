...
[2019-03-14] I learned how one doesn't need to compile header files, since they are compied into the cpp file through the include "preprocessor code"... in the end, as a wise man once said: "it just works".
